...
Перед тем как мы продолжим, будет полезно добавить механизм вывода диагностических сообщений. Техника вывода сообщений в местах принятия программой важных решений известна как **трассировка** (или tracing). С её помощью мы сможем отследить, какие решения принимает бот.
