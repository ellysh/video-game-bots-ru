...
---
Всегда предусматривайте способ [**отладки**](https://ru.wikipedia.org/wiki/Отладка_программы) (обнаружения и устранения ошибок) вашего приложения. Самый простой подход заключается в печати на консоль или в файл наиболее важных решений, принятых его алгоритмом.
---
