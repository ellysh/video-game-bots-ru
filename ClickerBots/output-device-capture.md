...
-----
 ...
 Это нужно для того, чтобы сохранить первоначальное изображение окна Блокнота. После ввода текста, мы передаем это изображение в функцию `FFLocalizeChanges`, и она сравнивает его с текущим.
