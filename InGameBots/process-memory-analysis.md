...
Первый шаг поиска - найти сегмент, хранящий искомую переменную. Воспользуемся 64-битной версией сканера Cheat Engine, чтобы найти переменную в памяти процесса и узнать её абсолютный адрес. Интерфейс 64 и 34 битных версий Cheat Engine одинаков.
