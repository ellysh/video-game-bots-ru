...
![Пакет с данными](Figure_4-7.png)
...
Вы могли заметить на иллюстрации 4-6, что пакет с номером 14, следующий за передачей данных, имеет ack номер равный четырём. Что это значит?
