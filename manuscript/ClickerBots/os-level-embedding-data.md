...
{caption: "Иллюстрация 2-2. Приложение AutoIt3 Info"}
...
{caption: "Иллюстрация 2-4. Чтение заголовка окна приложения в API Monitor"}
...
{caption: "Иллюстрация 2-5. Режимы координат, поддерживаемые WinAPI"}
