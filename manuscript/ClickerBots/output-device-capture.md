...
{caption: "Иллюстрация 2-7. Отображение графических объектов на устройства вывода"}
...
{caption: "Таблица 2-3. Режимы координат функций анализа изображений AutoIt"}
| Режим | Описание |
| --- | --- |
...
{caption: "Листинг 2-10. Скрипт `PixelGetColor.au3`", format: AutoIt}
![`PixelGetColor.au3`](code/ClickerBots/PixelGetColor.au3)
...
{caption: "Иллюстрация 2-8. WinAPI вызовы скрипта `PixelGetColor.au3`", height: "50%"}
...
{caption: "Листинг 2-11. Скрипт `PixelGetColorWindow.au3`", format: AutoIt}
![`PixelGetColorWindow.au3`](code/ClickerBots/PixelGetColorWindow.au3)
...
{caption: "Листинг 2-12. Скрипт `GetPixel.au3`", format: AutoIt}
![`GetPixel.au3`](code/ClickerBots/GetPixel.au3)
...
{caption: "Листинг 2-13. Скрипт `GetClientRect.au3`", format: AutoIt}
![`GetClientRect.au3`](code/ClickerBots/GetClientRect.au3)
...
{caption: "Листинг 2-14. Скрипт `PixelSearch.au3`", format: AutoIt}
![`PixelSearch.au3`](code/ClickerBots/PixelSearch.au3)
...
{caption: "Иллюстрация 2-9. WinAPI-вызовы функции `PixelSearch`"}
...
{caption: "Листинг 2-15. Скрипт `PixelSearchWindow.au3`", format: AutoIt}
![`PixelSearchWindow.au3`](code/ClickerBots/PixelSearchWindow.au3)
...
{caption: "Листинг 2-16. Скрипт `PixelChecksum.au3`", format: AutoIt}
![`PixelChecksum.au3`](code/ClickerBots/PixelChecksum.au3)
...
{caption: "Листинг 2-17. Файл `test.cpp`", format: C++}
![`test.cpp`](code/ClickerBots/test.cpp)
...
{caption: "Иллюстрация 2-10. Скриншот известной MMORPG-игры Lineage 2"}
...
{caption: "Листинг 2-18. Скрипт `FFBestSpot.au3`", format: AutoIt}
![`FFBestSpot.au3`](code/ClickerBots/FFBestSpot.au3)
...
{caption: "Таблица 2-4. Входные параметры функции `FFBestSpot`", width: "100%"}
| Параметр | Описание |
| --- | --- |
...
{caption: "Листинг 2-19. Скрипт `FFLocalizeChanges.au3`", format: AutoIt}
![`FFLocalizeChanges.au3`](code/ClickerBots/FFLocalizeChanges.au3)
...
{caption: "Таблица 2-5. Входные параметры функции `FFLocalizeChanges`"}
| Параметр | Описание |
| --- | --- |
...
{caption: "Иллюстрация 2-11. Иконка Notepad"}
...
{caption: "Листинг 2-20. Скрипт `Search.au3`", format: AutoIt}
![`Search.au3`](code/ClickerBots/Search.au3)
...
{caption: "Таблица 2-6. Входные параметры функции `_ImageSearch`", width: "100%"}
| Параметр | Описание |
| --- | --- |
