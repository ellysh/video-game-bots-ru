...
{caption: "Иллюстрация 4-16. Установка соединения между NetChess клиентом и сервером"}
...
{caption: "Таблица 4-2. Кодирование цвета фигур игрока на стороне сервера"}
| Байт | Цвет |
| --- | --- |
| 01 | Чёрный |
| 02 | Белый |
...
{caption: "Таблица 4-3. Коды букв полей шахматной доски"}
| Байт | Буква |
| --- | --- |
| 00 | a |
| 01 | b |
...
{caption: "Таблица 4-4. Коды номеров полей шахматной доски"}
| Байт | Номер |
| --- | --- |
| 07 | 1 |
| 06 | 2 |
